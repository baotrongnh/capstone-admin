          ...
          <>
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setField("buildingName", e.target.value || undefined)
                }
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                aria-invalid={
                  getFieldError("apartmentNumber") ? true : undefined
                }
              />
            ...
            <div className="space-y-1">
              ...
              <Select
                ...
                onValueChange={(value) => setField("furnishingStatus", value)}
              >
                <SelectTrigger
                  className="w-full"
                  aria-invalid={
                    getFieldError("furnishingStatus") ? true : undefined
                  }
                >
            ...
            <div className="space-y-1">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setField(
                    "yearBuilt",
                    value === "__empty__" ? undefined : Number(value),
                  )
                }
              >
                <SelectTrigger className="w-full">
            ...
            <div className="space-y-1">
              ...
              {usableAreaInvalid ? (
                <p className="text-xs text-destructive">
                  Diện tích sử dụng không được lớn hơn diện tích tổng.
                </p>
              ) : null}
            </div>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNumberField("numberOfBedrooms", e.target.value)
                }
                aria-invalid={
                  getFieldError("numberOfBedrooms") ? true : undefined
                }
              />
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNumberField("numberOfBathrooms", e.target.value)
                }
                aria-invalid={
                  getFieldError("numberOfBathrooms") ? true : undefined
                }
              />
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setCurrencyField("baseRentPrice", e.target.value)
                }
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setCurrencyField("depositAmount", e.target.value)
                }
              />
              {onSelectDepositPreset ? (
                <div className="pt-1">
                  <p className="mb-1 text-[11px] text-muted-foreground">
                    Chọn nhanh theo giá thuê
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <Button
                      ...
                      size="sm"
                      variant={
                        selectedDepositPreset === 1 ? "default" : "outline"
                      }
                    ...
                    <Button
                      ...
                      size="sm"
                      variant={
                        selectedDepositPreset === 2 ? "default" : "outline"
                      }
                      disabled={!canPickDepositPreset}
            ...
            <div className="space-y-1 md:col-span-2 xl:col-span-3">
              ...
              <ApartmentAddressFields
                ...
                onChange={({ wardCode }: { wardCode?: number }) =>
                  setField("wardCode", wardCode)
                }
              />
            </div>
            ...
            <div className="space-y-1 md:col-span-2 xl:col-span-3">
              ...
              <Input
                ...
                onChange={(e) =>
                  setField("streetAddress", e.target.value || undefined)
                }
              />
            </div>
