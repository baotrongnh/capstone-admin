...
export const useCreateOperator = () => {
  ...
  return useMutation({
    ...
    onError: (error) => {
      ...
      message.error("Lỗi khi thêm nhân viên vận hành.");
    },
  });
};
...
export const useUpdateOperator = (id: string) => {
  ...
  return useMutation({
    ...
    onError: (error) => {
      ...
      message.error("Lỗi khi cập nhật thông tin nhân viên vận hành.");
    },
  });
};
...
export const useDeleteOperator = (id: string) => {
  ...
  return useMutation({
    ...
    onError: (error) => {
      ...
      message.error("Lỗi khi khóa/mở khóa nhân viên vận hành.");
    },
  });
};
